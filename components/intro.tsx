...
A <b className="font-bold">full-stack developer</b> and <b className="font-bold">UI/UX designer</b> with{" "}
<b className="font-bold">4+ years</b> of experience. I specialize in building{" "}
<i className="italic">sites and apps</i> that are both functional and visually appealing.
      </motion.h1>
